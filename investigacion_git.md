...
## 4.¿Que es un "merge conflict" y como se resuelve?
    ...
    Para resolverlo, se deben revisar los archivos en conflicto, elegir que cambios conservar o combinar ambos cambios manualmente y luego guardar el archivo. Despues 
    se hace un commit para finalizzar el merge.
